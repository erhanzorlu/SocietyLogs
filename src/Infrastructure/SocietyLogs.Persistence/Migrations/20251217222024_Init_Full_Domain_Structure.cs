...
{
    /// <inheritdoc />
    public partial class Init_Full_Domain_Structure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxOccurrencePerDay = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PointDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunitySocialMedias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommunitySocialMedias_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatorCommunityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    RewardBadgeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Programs_Badges_RewardBadgeId",
                        column: x => x.RewardBadgeId,
                        principalTable: "Badges",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Programs_Communities_CreatorCommunityId",
                        column: x => x.CreatorCommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoLogPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SoLogPosts_AspNetUsers_AuthorUserId",
                        column: x => x.AuthorUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SoLogPosts_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SoLogPosts_SoLogPosts_ParentPostId",
                        column: x => x.ParentPostId,
                        principalTable: "SoLogPosts",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "CommunityPointHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CommunityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PointDefinitionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PointsAmount = table.Column<int>(type: "int", nullable: false),
                    NewTotalScore = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityPointHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommunityPointHistories_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityPointHistories_PointDefinitions_PointDefinitionId",
                        column: x => x.PointDefinitionId,
                        principalTable: "PointDefinitions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPointHistories_PointDefinitions_PointDefinitionId",
                        column: x => x.PointDefinitionId,
                        principalTable: "PointDefinitions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurriculumModules_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgramEnrollments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProgramSponsors",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProgramId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SponsorName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SponsorLogo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramSponsors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgramSponsors_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgramTasks_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostHashtags_SoLogPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "SoLogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderIndex = table.Column<int>(type: "int", nullable: false),
                    SoLogPostId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostMedias_SoLogPosts_SoLogPostId",
                        column: x => x.SoLogPostId,
                        principalTable: "SoLogPosts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoLogComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SoLogComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SoLogComments_SoLogComments_ParentCommentId",
                        column: x => x.ParentCommentId,
                        principalTable: "SoLogComments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SoLogComments_SoLogPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "SoLogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurriculumContents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurriculumContents_CurriculumModules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskSubmissions_ProgramTasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserContentProgresses_CurriculumContents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "CurriculumContents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityPointHistories_CommunityId",
                table: "CommunityPointHistories",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityPointHistories_PointDefinitionId",
                table: "CommunityPointHistories",
                column: "PointDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunitySocialMedias_CommunityId",
                table: "CommunitySocialMedias",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumContents_ModuleId",
                table: "CurriculumContents",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumModules_ProgramId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostMedias_SoLogPostId",
                table: "PostMedias",
                column: "SoLogPostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramEnrollments_UserId",
                table: "ProgramEnrollments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Programs_CreatorCommunityId",
                table: "Programs",
                column: "CreatorCommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_Programs_RewardBadgeId",
                table: "Programs",
                column: "RewardBadgeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramSponsors_ProgramId",
                table: "ProgramSponsors",
                column: "ProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramTasks_ProgramId",
                table: "ProgramTasks",
                column: "ProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_SoLogComments_ParentCommentId",
                table: "SoLogComments",
                column: "ParentCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_SoLogComments_PostId",
                table: "SoLogComments",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_SoLogComments_UserId",
                table: "SoLogComments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SoLogPosts_AuthorUserId",
                table: "SoLogPosts",
                column: "AuthorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SoLogPosts_CommunityId",
                table: "SoLogPosts",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_SoLogPosts_ParentPostId",
                table: "SoLogPosts",
                column: "ParentPostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPointHistories_PointDefinitionId",
